<template>
  ...
  <div class="progress-container">
    ...
    <section class="container-fluid project">
      ...
      <p>When we talked to our users, it became clear that we weren’t providing sufficient insights on how they perform. The most common way for hotels to get insights was in monthly meetings with a Market Manager from Agoda, who would bring a printed monthly report and discuss areas of improvements face-to-face.</p>
      ...
      <p>During our hotel visits, we interviewed the staff to understand how and when they used our system. We asked them to rank different features and data by importance, using card sorting.</p>

      <p>We consolidated the learnings and mapped out the most wanted features across the different types of hotels, markets and roles within hotels. By mapping out feature needs by role, it became clear that different roles have different needs:
        <ul>
          <li>
...
<img class="img-fluid" src="/projects/app-dashboard/initial-research-3-1920.png" alt="Roles and tasks of operational staff versus decision makers">
      ...
      <p>For example, if a hotelier analyses her bookings for the last 30 days for each nationality, compared to her competitors, she might find that her property attracts a significantly lower number of guests from the Japanese market.
      </p>
      <p>At this stage, our new tool can provide suggestions by looking at her hotel, their competitors and trends for Japanese travellers. For example, there might be certain amenities that are important for Japanese travellers, which her hotel doesn’t provide.
      </p>
      <p>
